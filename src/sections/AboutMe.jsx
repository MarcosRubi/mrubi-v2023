      ...
      <div className='container' id='about-me'>
        ...
        <div className='d-flex align-center flex-column flex-row-lg'>
          <div className='about-me__content'>
            ...
            <p>Dedicado al desarrollo web, con experiencia en HTML, CSS, JavaScript, React, MySQL y Git.</p>
            <p>Previamente, trabajé en Sortos Travel Multiservices, donde manejé WordPress, redes sociales y creé un sistema CRM en PHP.</p>
            <p>Actualmente, estoy enfocado en un sistema de control de préstamos, trabajando como freelancer.</p>
          </div>
