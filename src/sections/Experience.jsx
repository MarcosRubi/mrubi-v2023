      ...
      <div className='container'>
        ...
        <div className='experience__item d-flex align-center flex-column'>
          ...
          <div className='experience__activities'>
            ...
            <p><strong>Prácticas profesionales</strong>  realizando actividades como mantenimiento preventivo en computadoras, instalación de sistemas operativos y automatización de procesos en excel.</p>
          </div>
        </div>
        <div className='experience__item d-flex align-center flex-column'>
          <div className='experience__date w-100 text-center'>
            <h4>Soporte técnico</h4>
            <p>07 Jun 2017 ~ 07 Jul 2017</p>
          </div>
          <div className='experience__activities'>
            <h4>Instituciones Públicas De Educación En La Zona Oriental De El Salvador</h4>
